...
<form action="search.php" class="text-center" method="get">
<input type="text" name="search" class="w-75"value="<?php if(isset($_GET["search"])){ echo $_GET["search"];}?>">
<input type="submit" value="Wyszukaj" class="btn blue">
</form>
<?php
if(mainInputCheck())
{
...
{
    $sql="select * from users where imie LIKE '%".$_GET["search"]."%' or nazwisko LIKE '%".$_GET["search"]."%';";
